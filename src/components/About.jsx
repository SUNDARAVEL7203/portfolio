...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white   height: 100%;
  margin: 0;"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        contribute effectively to innovative projects while growing as a proficient software developer in the 
        ...
        <p className="text-xl">
        As a detail-oriented individual, I value teamwork, problem-solving, and creating impactful digital solutions.
        My goal is to grow as a proficient software developer while contributing effectively to innovative projects 
        in a fast-paced tech environment. I am eager to turn ideas into reality and bring value to the teams I collaborate 
        with.
        </p>
      </div>
    </div>
